      ...
      <div className="container mx-auto mt-32">
        ...
        <div className="grid grid-cols lg:grid-cols-2 gap-6">
          ...
          >
            {/* Text */}
            <div>
              <h2 className="text-[50px] text-accent leading-tight font-bold mb-2">
                {" "}
                {content.newest} <br /> {content.myWork}
              </h2>
              <p className=" mb-16 text-right text-[25px]">
                {" "}
                {content.lookWork}{" "}
              </p>
              <button className="btn btn-lg text-[20px]">
                {" "}
                {content.lookAll}
              </button>
            </div>
            ...
            <div className="group relative overflow-hidden border-2 border-[#B809C3] rounded-xl ">
              ...
              <div className="absolute -bottom-full left-[110px] sm:left-[150px] md:left-[250px] group-hover:bottom-[50px] transition-all duration-1000 z-40">
                <a href="https://www.behance.net/gallery/180458825/RealEstate-Application">
                  <span className="text-xl sm:text-2xl text-white px-6 sm:py-1 rounded-full border hover:bg-black/70 duration-500 cursor-pointer">
                    See
                  </span>
                </a>
              </div>
          ...
          >
            ...
            <div className="group relative overflow-hidden border-2 border-[#B809C3] rounded-xl ">
              ...
              <div className="absolute -bottom-full left-2 md:left-12 group-hover:bottom-6  transition-all duration-1000 z-40">
                <span className="text-2xl sm:text-3xl text-white">
                  Best East <br /> Dillevery
                </span>
              </div>
              <div className="absolute -bottom-full left-[110px] sm:left-[150px] md:left-[250px] group-hover:bottom-[50px] transition-all duration-1000 z-40">
                <a href="https://www.behance.net/gallery/180457803/Best-Eat-Delivery-Application">
                  <span className="text-xl sm:text-2xl text-white px-6 sm:py-1 rounded-full border hover:bg-black/70 duration-500 cursor-pointer">
                    See
                  </span>
                </a>
              ...
              <div className="absolute -bottom-full left-[200px] sm:left-[250px] md:left-[400px] group-hover:bottom-[50px] transition-all duration-1000 z-40">
                <a href="https://fastfood-project.firebaseapp.com/">
                  <span className="text-xl sm:text-2xl text-white px-6 sm:py-1 rounded-full border hover:bg-black/70 duration-500 cursor-pointer">
                    Visit
                  </span>
                </a>
            ...
            <div className="group relative overflow-hidden border-2 border-[#B809C3] rounded-xl ">
              ...
              <div className="absolute -bottom-full left-[110px] sm:left-[150px] md:left-[250px] group-hover:bottom-[50px] transition-all duration-1000 z-40">
                <a href="https://www.behance.net/gallery/180458175/To-Do-Application">
                  <span className="text-xl sm:text-2xl text-white px-6 sm:py-1 rounded-full border hover:bg-black/70 duration-500 cursor-pointer">
                    See
                  </span>
                </a>
