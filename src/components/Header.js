  ...
  return (
    <div className="pt-8 ">
      <div
        className={
          language === "english"
            ? "flex flex-row-reverse justify-between items-center container mx-auto"
            : "flex justify-between items-center container mx-auto"
        }
      >
        <div
          className={`flex ${
            language === "kurdish" ? "flex" : "flex-row-reverse"
          } items-center space-x-3`}
        >
          <button
            onClick={handleToggle}
            className=" bg-accent rounded-full text-4xl cursor-pointer mx-2"
          >
            <GrLanguage />
          </button>
        ...
        <div className=" text-[35px] lg:text-[60px] font-bold leading-[0.8]">
      ...
      <div
        className={
          open && language === "kurdish"
            ? "flex container mx-auto duration-700 ease-in-out"
            : open && language === "english"
            ? "flex container mx-auto justify-end duration-700 ease-in-out"
            : `flex container mx-auto ${
                language === "english" ? "justify-end" : "justify-start"
              } -translate-y-52 duration-700 ease-in-out`
        }
      >
