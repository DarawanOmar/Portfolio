      ...
      <div className="container mx-auto ">
        <div
          className={`flex flex-col gap-y-10 ${
            language === "kurdish" ? "lg:flex-row" : "lg:flex-row-reverse"
          } lg:items-center lg:gap-x-20 lg:gap-y-0 md:h-screen`}
        >
          {/* Image */}
          <motion.div
            className="flex md:flex-1 bg-about bg-contain h-[400px] bg-no-repeat mix-blend-lighten bg-top "
          ...
          {/* Text */}
          <motion.div
            className="flex-1 flex flex-col justify-end items-end text-right"
          ...
          >
            ...
            <div className="flex gap-x-6 lg:gap-x-10 mb-12 ">
              <div>
                ...
                <div className="font-primary text-sm tracking-[2px] text-right">
                  {" "}
                  {content.project} <br />
                  {content.completed}
                </div>
